...
from rsl_rl.modules.network import Network, DoubleHeadNetwork
...
class DoubleHeadGaussianNetwork(DoubleHeadNetwork):
    """A network to predict mean and std of a gaussian distribution where std is a tunable parameter."""
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(input_size, [output_size, 1], **kwargs)
    ...
    def forward(self, x: torch.Tensor, compute_std: bool = False, **kwargs) -> Tuple[torch.Tensor]:
        mean, v = super().forward(x, **kwargs)
